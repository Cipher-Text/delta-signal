...
The dashboard is documented in [../../docs/dashboard.md](../../docs/dashboard.md). Its current presentation uses shared dashboard primitives and responsive CSS; the visual treatment does not alter API contracts or access control.
