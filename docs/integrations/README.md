...
| [OpenMeteo Marine Weather](openmeteo-marine.md) | Implemented | Daily wave, swell, and wind-wave forecasts for coastal districts; hourly SST and current variables are not stored |
